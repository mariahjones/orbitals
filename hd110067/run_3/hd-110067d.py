...
sim.dt = 0.001
sim.save_to_file('hd_d.bin', interval=10,delete_file=True) # save as binary file
...
for i in range(20):
    a = sem_maj_ax[i]
    hash_val = 'Trojan_110067d_{}'.format(i)
...
Nout = 100 # number of points to display
tmax = 1000 # let the simulation run for 10^3 years
Nplanets = 6
